...
import { getAllOperators, getAllOffices, getAllRoles, getAllCategories, getAllPendingReports, getAllApprovedReports, getOperatorsByOffice } from "./functionalities/get-all.mjs";
...
const API = { logIn, getUserInfo, logOut, signUp, getAllOperators, getAllOffices, getAllRoles, 
    ...
    getAllPendingReports, updateReportStatus, getAllApprovedReports, getOperatorsByOffice };
