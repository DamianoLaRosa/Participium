...
export default function InsertReportPage() {
  ...
  // Redirect to map page if location data is missing
  useEffect(() => {
    if (!location.position || !location.address || !location.coordinates) {
      navigate("/map");
    }
  }, [location, navigate]);
        ...
        <form action={formAction} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            <label className={styles.checkboxLabel}>
              ...
              />
              <span>
                Make this report anonymous (your name will not be visible in the
                public list)
              </span>
            </label>
          </div>
